...
<?else:?>
	<input type="text" name="q" class="search-page__form-text" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
...
<?endif;?>
	&nbsp;<input type="submit" value="<?=GetMessage("SEARCH_GO")?>"  class="search-page__form-submit" />
